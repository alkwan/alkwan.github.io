...
<div id="main" class="alt">
	<section id="one">
		<div class="inner">
			...
			<p>Afer conducting research, I created some user personas to help inform our designs. Finally, after another member created our initial paper wireframes, I designed the user interface and screens that would be used in our final prototype. At the Info 200 project fair, our group won the Best UX/UI Award.</p>
			...
			<p>Two years later, I revisited this project. This project was my first foray into the world of UX/UI design and I loved it, but time did not do this design well and I knew I could do better. So I started over and returned to the user interviews I conducted, and came to different conclusions than last time.</p>
			<p>In the previous iteration, we focused a lot on directions. But reading the interviews again, I realized that biggest problem people ran into was finding clubs, a community, and events to go to in between classes. So I shifted the app's focus: instead of being a navigation-based app, I decided to create a schedule/event app with navigational capabilities.</p>
